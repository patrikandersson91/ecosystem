...
export default function Trees() {
  ...
  return (
    <group>
      <instancedMesh ref={trunkMeshRef} args={[undefined, undefined, count]} castShadow receiveShadow>
        <cylinderGeometry args={[0.15, 0.25, 2, 6]} />
        <meshStandardMaterial color="#6b3e26" />
      </instancedMesh>
      <instancedMesh ref={canopyMeshRef} args={[undefined, undefined, count]} castShadow receiveShadow>
