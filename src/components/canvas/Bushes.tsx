...
export default function Bushes() {
  ...
  return (
    <group>
      {/* Main bush sphere */}
      <instancedMesh ref={mesh1Ref} args={[undefined, undefined, count]} castShadow receiveShadow geometry={geo1}>
        <meshStandardMaterial color="#3a7d28" roughness={0.9} />
      </instancedMesh>
      
      {/* Secondary lobe */}
      <instancedMesh ref={mesh2Ref} args={[undefined, undefined, count]} castShadow receiveShadow geometry={geo2}>
        <meshStandardMaterial color="#2e6b1e" roughness={0.9} />
      </instancedMesh>
      
      {/* Third lobe */}
      <instancedMesh ref={mesh3Ref} args={[undefined, undefined, count]} castShadow receiveShadow geometry={geo3}>
